...
export default async function InvoicePage({
    ...
    // Use params and searchParams directly as plain objects
    ...
    // Remove updateStatusAction from render phase
    ...
    if (isSuccess) {
        ...
        // Do NOT call updateStatusAction here
    }
    ...
    // Helper: show a button to mark as paid if payment is successful but invoice is not updated
    const needsMarkPaid = isSuccess && paymentStatus === "paid" && invoice.status !== "paid";
            ...
            <Container>
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div>
                        ...
                        {/* If payment succeeded but invoice is not marked as paid, show a button to update status */}
                        {needsMarkPaid && (
                            <form action={updateStatusAction} method="post">
                                <input type="hidden" name="id" value={invoice.id} />
                                <input type="hidden" name="status" value="paid" />
                                <Button className="flex gap-2 font-bold bg-blue-700 mt-4">
                                    Mark as Paid
                                </Button>
                            </form>
                        )}
